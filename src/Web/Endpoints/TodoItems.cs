using EpicureanVault.Application.Common.Models;
using EpicureanVault.Application.TodoItems.Commands.CreateTodoItem;
using EpicureanVault.Application.TodoItems.Commands.DeleteTodoItem;
using EpicureanVault.Application.TodoItems.Commands.UpdateTodoItem;
using EpicureanVault.Application.TodoItems.Commands.UpdateTodoItemDetail;
using EpicureanVault.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace EpicureanVault.Web.Endpoints;
